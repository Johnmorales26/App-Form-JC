...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.actvCountries.setOnItemClickListener { _, view, _, _ ->
            ...
            Toast.makeText(
                this, (view as AppCompatCheckedTextView).text.toString(), Toast.LENGTH_SHORT
            ).show()
        }
    ...
    @Composable
    private fun EtHeight(onValueChange: (String) -> Unit) {
        ...
        Column {
            ...
            Text(
                text = if (isError) {
                    ...
                    stringResource(id = R.string.help_min_height)
                },
    ...
    @Composable
    private fun EtSurname(onValueChange: (String) -> Unit) {
        var textValue by remember { mutableStateOf("") }
        var isError by remember { mutableStateOf(false) }
        Column {
            OutlinedTextField(
            ...
            if (validFields()) {
                ...
                builder.setMessage(
                    joinData(
                        name,
                        textSurname,
                        textHeight, dateBirth, country, placeBirth, notes
                    )
                )
